...
- stats\_threshold
    ...
    done explicitly via the __refresh__ method of an 
    [IBM:StorageSystem::Statistic](IBM:StorageSystem::Statistic) object.
...
True if the auth\_service\_type is configured and either one of the following 
is true:
...
__Note__ that this method returns an array of tier capacity ivalues, the index 
...
Please report any bugs or feature requests to `bug-ibm-v7000unified at rt.cpan.org`, or through
the web interface at [http://rt.cpan.org/NoAuth/ReportBug.html?Queue=IBM-V7000Unified](http://rt.cpan.org/NoAuth/ReportBug.html?Queue=IBM-V7000Unified).  I will be notified, and then you'll
...
- RT: CPAN's request tracker (report bugs here)
    ...
    [http://rt.cpan.org/NoAuth/Bugs.html?Dist=IBM-V7000Unified](http://rt.cpan.org/NoAuth/Bugs.html?Dist=IBM-V7000Unified)

- AnnoCPAN: Annotated CPAN documentation

    [http://annocpan.org/dist/IBM-V7000Unified](http://annocpan.org/dist/IBM-V7000Unified)

- CPAN Ratings

    [http://cpanratings.perl.org/d/IBM-V7000Unified](http://cpanratings.perl.org/d/IBM-V7000Unified)

- Search CPAN

    [http://search.cpan.org/dist/IBM-V7000Unified/](http://search.cpan.org/dist/IBM-V7000Unified/)
